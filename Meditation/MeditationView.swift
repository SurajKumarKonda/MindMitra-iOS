                ...
                VStack(alignment: .leading, spacing: 24) {
                    ...
                    Button {
                        ...
                        Label("Play", systemImage: "play.fill")
                            ...
                            .cornerRadius(20)
                            .overlay(
                                RoundedRectangle(cornerRadius: 16).stroke(LinearGradient(colors: [.white, .white.opacity(0.5)], startPoint: .topLeading, endPoint: .bottomTrailing), lineWidth: 3)
                                    .blendMode(.overlay)
                            )
